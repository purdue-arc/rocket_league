...
class MeanOdomFilter(object):
    ...
    def __init__(self):
        ...
        self.node = rclpy.create_node('mean_odom_filter')
        ...
        self.POS_COUNT = self.node.declare_parameter('~buffer_size/position', 3)
        self.VEL_COUNT = self.node.declare_parameter('~buffer_size/velocity', 3)

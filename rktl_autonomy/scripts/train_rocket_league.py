...
if __name__ == '__main__':      # this is required due to forking processes
    ...
    env = make_vec_env(RocketLeagueInterface, env_kwargs={'run_id':run_id, 'launch_args': ['render:=false', 'plot_log:=true']},
            n_envs=24, vec_env_cls=SubprocVecEnv)

    # model = PPO("MlpPolicy", env)
    model = PPO("MlpPolicy", env)
    GME_run_id = '7b920d7b-cb42-4267-a941-b050c80fe7a3'
    GME_name = 'rl_model_99998400_steps'
